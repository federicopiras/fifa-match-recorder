...
def save_match_to_csv(player1, fifa_version, team1, goals1, stars1, player2, team2, goals2, stars2, match_type):
    match_data = {
...
def save_match_to_google_sheets(sheet_name, fifa_version, player1, team1, goals1, stars1, champ1, nation1,
